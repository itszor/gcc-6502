  ...
  [(parallel
    [(set (pc) (if_then_else
		 (match_operator 0 "m65x_comparison"
	           [(match_operand:QIHI2 1 "general_operand" "")
		    (match_operand:QIHI2 2 "general_operand" "")])
...
;  [(set (pc) (if_then_else
;	       (eq (match_operand:HI 0 "ptr_reg_operand"   "r,r")
...
;			       operands[3], BLOCK_FOR_INSN (curr_insn));
;  DONE;
;})

;(define_insn_and_split "cbrhi_ne"
;  [(set (pc) (if_then_else
;	       (ne (match_operand:HI 0 "ptr_reg_operand"   "r,r")
;		   (match_operand:HI 1 "nonmemory_operand" "r,i"))
;	       (label_ref (match_operand 2 "" ""))
;	       (pc)))
;   (clobber (match_scratch:QI 3 "=hq,hq"))
...
;  [(set (pc) (if_then_else
;	       (ltu (match_operand:HI 0 "ptr_reg_operand"   "r,r")
;		    (match_operand:HI 1 "nonmemory_operand" "r,i"))
;	       (label_ref (match_operand 2 "" ""))
;	       (pc)))
;   (clobber (match_scratch:QI 3 "=hq,hq"))
...
;  [(set (pc) (if_then_else
;	       (gtu (match_operand:HI 0 "nonmemory_operand" "r,i")
;		    (match_operand:HI 1 "ptr_reg_operand"   "r,r"))
;	       (label_ref (match_operand 2 "" ""))
;	       (pc)))
;   (clobber (match_scratch:QI 3 "=hq,hq"))
;   (clobber (reg:CC_NZ NZ_REGNUM))
...
;  [(set (pc) (if_then_else
;	       (geu (match_operand:HI 0 "ptr_reg_operand"   "r,r")
;		    (match_operand:HI 1 "nonmemory_operand" "r,i"))
;	     (label_ref (match_operand 2 "" ""))
;	     (pc)))
;   (clobber (match_scratch:QI 3 "=hq,hq"))
...
;  [(set (pc) (if_then_else
;	       (leu (match_operand:HI 0 "nonmemory_operand" "r,i")
;		    (match_operand:HI 1 "ptr_reg_operand"   "r,r"))
;	     (label_ref (match_operand 2 "" ""))
;	     (pc)))
;   (clobber (match_scratch:QI 3 "=hq,hq"))
...
;  [(set (pc) (if_then_else
;	       (lt (match_operand:HI 0 "ptr_reg_operand"   "r,r")
;		   (match_operand:HI 1 "nonmemory_operand" "r,i"))
;	       (label_ref (match_operand 2 "" ""))
;	       (pc)))
...
;  [(set (pc) (if_then_else
;	       (gt (match_operand:HI 0 "nonmemory_operand" "r,i")
;		   (match_operand:HI 1 "ptr_reg_operand"   "r,r"))
;	       (label_ref (match_operand 2 "" ""))
;	       (pc)))
;   (clobber (match_scratch:QI 3 "=Aq,Aq"))
...
;  [(set (pc) (if_then_else
;	       (ge (match_operand:HI 0 "ptr_reg_operand"   "r,r")
;		   (match_operand:HI 1 "nonmemory_operand" "r,i"))
;	       (label_ref (match_operand 2 "" ""))
;	       (pc)))
;   (clobber (match_scratch:QI 3 "=Aq,Aq"))
...
;  [(set (pc) (if_then_else
;	       (le (match_operand:HI 0 "nonmemory_operand" "r,i")
;		   (match_operand:HI 1 "ptr_reg_operand"   "r,r"))
;	       (label_ref (match_operand 2 "" ""))
;	       (pc)))
;   (clobber (match_scratch:QI 3 "=Aq,Aq"))
