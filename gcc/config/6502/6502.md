  ...
  ""
{
  ...
  if (!lra_in_progress)
      ...
      if (!can_create_pseudo_p ())
	{
      ...
      if ((strict_ptr_reg_operand (operands[0], <MODE>mode)
	   /*|| reg_overlap_mentioned_p (virtual_stack_vars_rtx, operands[0])*/)
	  && (strict_ptr_reg_operand (operands[1], <MODE>mode)
	      /*|| reg_overlap_mentioned_p (virtual_stack_vars_rtx, operands[1])*/))
