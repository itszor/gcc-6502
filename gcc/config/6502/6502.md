...
;    {
;    case 0: return "ldy #1\;lda (%1),y\;sta _ah\;lda (%1)";
;    case 1: return "ldy #%2\;lda (%1),y\;sta _ah\;dey\;lda (%1),y";
;    default: gcc_unreachable ();
;    }
;}
;  [(set_attr "length" "8,9")])
...
;   (clobber (match_scratch:QI 2 "=yh"))]
;  ""
;  "sta (%0)\;ldy #1\;pha\;lda _ah\;sta (%0),y\;pla"
;  [(set_attr "length" "10")])
...
;  switch (which_alternative) 
;    {
;    case 0: return "sta (%0)\;ldy #1\;pha\;lda _ah\;sta (%0),y\;pla";
;    case 1: return "ldy #%1\;sta (%0),y\;iny\;pha\;lda _ah\;sta (%0),y\;pla";
;    default: gcc_unreachable ();
;    }
;}
