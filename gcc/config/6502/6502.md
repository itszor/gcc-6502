  ...
  [(parallel
    [(set (pc) (if_then_else
		 (match_operator 0 "m65x_comparison"
		    ...
		    (match_operand:QIHI 2 "general_operand" "")])
...
(define_insn_and_split "cbrhi_eq"
  [(set (pc) (if_then_else
	       (eq (match_operand:HI 0 "general_operand" "r,r")
...
(define_insn_and_split "cbrhi_ne"
  [(set (pc) (if_then_else
	       (ne (match_operand:HI 0 "general_operand" "r,r")
		   (match_operand:HI 1 "general_operand" "r,i"))
	       (label_ref (match_operand 2 "" ""))
	       (pc)))
   (clobber (match_scratch:QI 3 "=hq,hq"))
...
(define_insn_and_split "cbrhi_ltu"
  [(set (pc) (if_then_else
	       (ltu (match_operand:HI 0 "general_operand" "r,r")
		    (match_operand:HI 1 "general_operand" "r,i"))
	       (label_ref (match_operand 2 "" ""))
	       (pc)))
   (clobber (match_scratch:QI 3 "=hq,hq"))
...
(define_insn_and_split "cbrhi_gtu"
  [(set (pc) (if_then_else
	       (gtu (match_operand:HI 0 "general_operand" "r,i")
...
(define_insn_and_split "cbrhi_geu"
  [(set (pc) (if_then_else
	       (geu (match_operand:HI 0 "general_operand" "r,r")
		    (match_operand:HI 1 "general_operand" "r,i"))
	     (label_ref (match_operand 2 "" ""))
	     (pc)))
   (clobber (match_scratch:QI 3 "=hq,hq"))
...
(define_insn_and_split "cbrhi_leu"
  [(set (pc) (if_then_else
	       (leu (match_operand:HI 0 "general_operand" "r,i")
		    (match_operand:HI 1 "general_operand" "r,r"))
	     (label_ref (match_operand 2 "" ""))
	     (pc)))
   (clobber (match_scratch:QI 3 "=hq,hq"))
...
(define_insn_and_split "cbrhi_lt"
  [(set (pc) (if_then_else
	       (lt (match_operand:HI 0 "general_operand" "r,r")
		   (match_operand:HI 1 "general_operand" "r,i"))
	       (label_ref (match_operand 2 "" ""))
	       (pc)))
...
(define_insn_and_split "cbrhi_gt"
  [(set (pc) (if_then_else
	       (gt (match_operand:HI 0 "general_operand" "r,i")
		   (match_operand:HI 1 "general_operand" "r,r"))
	       (label_ref (match_operand 2 "" ""))
	       (pc)))
   (clobber (match_scratch:QI 3 "=Aq,Aq"))
...
(define_insn_and_split "cbrhi_ge"
  [(set (pc) (if_then_else
	       (ge (match_operand:HI 0 "general_operand" "r,r")
		   (match_operand:HI 1 "general_operand" "r,i"))
	       (label_ref (match_operand 2 "" ""))
	       (pc)))
   (clobber (match_scratch:QI 3 "=Aq,Aq"))
...
(define_insn_and_split "cbrhi_le"
  [(set (pc) (if_then_else
	       (le (match_operand:HI 0 "general_operand" "r,i")
		   (match_operand:HI 1 "general_operand" "r,r"))
	       (label_ref (match_operand 2 "" ""))
	       (pc)))
   (clobber (match_scratch:QI 3 "=Aq,Aq"))
