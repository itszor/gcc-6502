...
(define_insn "lshrhi3"
  [(set (match_operand:HI 0 "accumulator_operand"		"=A")
	(lshiftrt:HI (match_operand:HI 1 "accumulator_operand"	 "0")
		     (match_operand:HI 2 "shifthi_amount"	 "N")))
   (clobber (match_scratch:QI 3 "=&j"))]
  ""
{
  switch (INTVAL (operands[2]))
    ...
    case 5:
      return "asl ah\;rol a\;asl ah\;rol a\;asl ah\;rol a\;and #7\;ld%R3 ah\;"
	     "sta ah\;t%R3a";
    case 6:
      return "asl a\;rol ah\;php\;asl a\;rol ah\;pla\;asl a\;adc #0\;"
...
(define_insn "lshrhi3_addhi"
  [(set (match_operand:HI 0 "zp_reg_operand"				"=r")
	(plus:HI (lshiftrt:HI (match_operand:HI 1 "accumulator_operand"  "A")
			      (match_operand:HI 2 "shifthi_rt_byteswap"  "O"))
...
(define_insn "ashlhi3"
  [(set (match_operand:HI 0 "accumulator_operand"		"=A")
	(ashift:HI (match_operand:HI 1 "accumulator_operand"	 "0")
		   (match_operand:HI 2 "shifthi_amount"		 "N")))]
  ""
  "asl a\;rol ah")
