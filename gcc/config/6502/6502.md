...
; get upset without r<-m and m<-r alternatives for QImode moves.
  ...
  [(pc)]
{
  ...
  emit_insn (gen_rtx_SET (VOIDmode, tmp1, yreg));
  emit_insn (gen_rtx_SET (VOIDmode, tmp0, acc));
  emit_insn (gen_loadqi_indy (acc, yreg, operands[1]));
  emit_insn (gen_rtx_SET (VOIDmode, operands[0], acc));
  emit_insn (gen_rtx_SET (VOIDmode, acc, tmp0));
  emit_insn (gen_rtx_SET (VOIDmode, yreg, tmp1));
  ...
  [(pc)]
{
  ...
  emit_insn (gen_rtx_SET (VOIDmode, tmp1, yreg));
  emit_insn (gen_rtx_SET (VOIDmode, tmp0, acc));
  emit_insn (gen_rtx_SET (VOIDmode, acc, operands[1]));
  emit_insn (gen_storeqi_indy (yreg, operands[0], acc));
  emit_insn (gen_rtx_SET (VOIDmode, acc, tmp0));
  emit_insn (gen_rtx_SET (VOIDmode, yreg, tmp1));
