...
; registers out of the way (in split_reg). The following instruction(s) is
; here simply to appease it, though ideally we wouldn't need them.
...
(define_insn "ashlqi3"
  [(set (match_operand:QI 0 "accumulator_operand"	     "=Aq,r,Uc")
	(ashift:QI (match_operand:QI 1 "accumulator_operand"   "0,0, 0")
		   (match_operand:QI 2 "shiftqi_amount"       "NB,K, K")))]
  ""
{
