...
(define_insn_and_split "*movhi_insn"
  [(set (match_operand:HI 0 "nonimmediate_operand"
			   "=hc,Ac,hc,xc,yc,hc, r,hc,Uc,Ac, m,r,r, r,Uc,Uc")
	(match_operand:HI 1 "general_operand"
			     "i,hc,Ac,xc,yc, r,hc,Uc,hc, m,Ac,r,i,Uc, r, z"))]
  ...
  [(pc)]
{
  ...
  rtx tmp1 = gen_rtx_REG (QImode, TMP0_REGNUM);
...
(define_insn "safe_wordmove"
  [(set (match_operand:QI 0 "mov_dst_operand" "=r,r, r,Uc, r,Uc")
	(match_operand:QI 1 "mov_src_operand"  "r,i,hh,hh,Uc, r"))
...
(define_insn "storehi_const_mem"
  [(set (match_operand:HI 0 "const_mem_operand" "=Uc")
	(match_operand:HI 1 "register_operand"   "hc"))
...
(define_insn "*lo_sum_addr"
  [(set (match_operand:HI 0 "zp_reg_operand" "=r")
	(plus:HI (zero_extend:HI
		   (match_operand:QI 2 "y_reg_operand" "yh"))
		 (match_operand:HI 1 "zp_reg_operand" "0")))]
  ""
...
(define_insn "*movqi_insn"
  [(set (match_operand:QI 0 "mov_dst_operand"
       "=hh,Ah,hh,r,hh, r,hh,Uc,Ah, m,r,Uc,xh,yh,?hh, ?m")
	(match_operand:QI 1 "mov_src_operand"
	 "i,hh,Ah,r, r,hh,Uc,hh, m,Ah,z, z,yh,xh, ?m,?hh"))]
  ...
  #
  #"
 [(set_attr "length" "2,1,1,*,2,2,3,3,*,*,2,3,2,2,*,*")])
...
(define_insn_and_split "*loadqi_indy_tmps"
  [(set (match_operand:QI 0 "hard_reg_operand"			  "=Ah,?jh")
	(unspec:QI
...
(define_insn "loadqi_indy"
  [(set (match_operand:QI 0 "accumulator_operand" "=Ah")
	(mem:QI (plus:HI
		  (zero_extend:HI (match_operand:QI 1 "y_reg_operand" "yh"))
...
(define_insn_and_split "*storeqi_indy_tmps"
  [(set (mem:QI (plus:HI (match_operand:HI 0 "zp_reg_operand" "=r,?r")
	...
	(unspec:QI [(match_operand:QI 2 "hard_reg_operand" "=Ah,?jh")]
		   UNSPEC_STOREQI))]
  ""
  "#"
  "reload_completed"
...
(define_insn "storeqi_indy"
  [(set (mem:QI (plus:HI
		  (zero_extend:HI (match_operand:QI 0 "y_reg_operand" "yh"))
...
;  [(parallel [(set (match_operand:QI 0 "y_reg_operand" "=yh")
;		   (match_operand:QI 1 "memory_operand" "Uy"))
;	      (clobber (match_operand:QI 2 "accumulator_operand" "=Ah"))])]
;  ""
;{})
;
;(define_insn "reload_y_inqi_indy"
;  [(set (match_operand:QI 0 "y_reg_operand" "=yh")
;	(mem:QI (plus:HI (match_operand:HI 1 "zp_reg_operand" "r")
;			 (match_operand:HI 2 "const_byte_amount" "i"))))
;   (clobber (match_scratch:QI 3 "=Ah"))]
;  ""
...
;		   (match_operand:QI 1 "y_reg_operand" "=yh"))
;	      (clobber (match_operand:QI 2 "accumulator_operand" "=Ah"))])]
;  ""
;{})
;
...
(define_insn "andqi3"
  [(set (match_operand:QI 0 "accumulator_operand"	  "=Ah,Ah,Ah")
	(and:QI (match_operand:QI 1 "accumulator_operand"   "0, 0, 0")
		(match_operand:QI 2 "qimode_src_operand"    "r, m, I")))]
  ""
  "@
  and %2
  and %2
  ...
  ""
{
  ...
  [(set (attr "length")
	(if_then_else (and (ge (minus (match_dup 1) (pc)) (const_int -120))
			   (lt (minus (match_dup 1) (pc)) (const_int 120)))
		      (const_int 2)
		      (const_int 5)))])
