...
(define_insn_and_split "add<mode>3_insn"
  [(set (match_operand:HISI 0 "nonimmediate_operand"       "=&r,r")
        (plus:HISI (match_operand:HISI 1 "general_operand"  "%r,r")
                   (match_operand:HISI 2 "general_operand"   "r,i")))]
  ""
  "@
...
(define_insn "movqi_noclob"
  [(set (match_operand:QI 0 "nonimmediate_operand"
	  "=hq,hq, r,hq,Uc,hq, <,hq, <,Aq,Aq, m,r,Uc,?hq, ?m,?r,?m,?r,?r,rhq")
	(match_operand:QI 1 "general_operand"
	    "i, r,hq,Uc,hq,hq,hq, >,Aq, >, m,Aq,z, z, ?m,?hq,?m,?r,?i,?r,  0"))]
  "m65x_valid_mov_operands (QImode, operands, true)"
{
  return m65x_print_movqi (which_alternative, operands, true);
}
  [(set_attr "length" "4,4,4,5,5,6,3,3,3,3,10,10,4,5,11,15,16,16,8,8,0")
  ...
  "m65x_valid_mov_operands (QImode, operands, true)"
{
  ...
  [(set_attr "length" "2,2,2,3,3,4,1,1,1,1,8,8,2,3,9,13,14,14,6,6,0")
   (set_attr "arch" "*,*,*,*,*,*,phx,phx,no_phx,no_phx,*,*,cmos,cmos,*,*,\
		     *,*,*,*,*")])
