...
(define_insn "movhi_sty_indy"
  [(set (mem:HI (plus:HI (match_operand:HI 0 "zp_reg_operand" "r")
...
(define_insn "load_acc_ind"
  [(set (match_operand:HI 0 "accumulator_operand"	"=Ac")
	(mem:HI (match_operand:HI 1 "zp_reg_operand"	  "r")))
...
(define_insn "load_acc_indy"
  [(set (match_operand:HI 0 "accumulator_operand"		"=Ac,Ac")
        (mem:HI (plus:HI (match_operand:HI 1 "zp_reg_operand"     "r, r")
...
(define_insn "store_acc_ind"
  [(set (mem:HI (match_operand:HI 0 "zp_reg_operand" "r"))
	(match_operand:HI 1 "accumulator_operand" "Ac"))
   (clobber (match_scratch:QI 2 "=yh"))]
  ""
...
(define_insn "store_acc_indy"
  [(set (mem:HI (plus:HI (match_operand:HI 0 "zp_reg_operand"    "r,r")
