...
(define_insn "movqi_insn"
  [(set (match_operand:QI 0 "nonimmediate_operand"
			  "=hq,hq, r,hq,Uc,hq,<, hq,Aq, m,r,Uc,?hq, ?m,?r,?m")
	(match_operand:QI 1 "general_operand"
			    "i, r,hq,Uc,hq,hq,hq, >, m,Aq,z, z, ?m,?hq,?m,?r"))
   (clobber (reg:CC_NZ NZ_REGNUM))]
  "m65x_valid_mov_operands (QImode, operands)"
{
  switch (which_alternative)
	...
	case X_REGNUM:
	  switch (REGNO (operands[1]))
	    ...
	    case Y_REGNUM: return "sty _tmp0\;ldx _tmp0";
	    default: gcc_unreachable ();
	    }
	...
	case Y_REGNUM:
	  switch (REGNO (operands[1]))
	    ...
	    case X_REGNUM: return "stx _tmp0\;ldy _tmp0";
 ...
 [(set_attr "length" "2,2,2,3,3,4,1,1,8,8,2,3,9,13,14,14")])
...
(define_insn "adcqi3_c"
  [(set (match_operand:QI 0 "accumulator_operand"	     "=Aq,Aq,Aq")
	(plus:QI
	  (plus:QI (match_operand:QI 1 "accumulator_operand"   "0, 0, 0")
		   (match_operand:QI 2 "qimode_src_operand"    "r, i, m"))
