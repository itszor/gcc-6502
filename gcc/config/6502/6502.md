...
(define_insn "*movhi_insn"
  [(set (match_operand:HI 0 "movhi_dst_operand"
					    "=hc,Ac,jc,hc, ?r,hc,r,U,r,U,*Ac")
	(match_operand:HI 1 "movhi_src_operand"
...
(define_insn_and_split "cbrhi_ltu"
  [(set (pc) (if_then_else
	       (ltu (match_operand:HI 0 "register_operand"  "hc,hc,r,hc,r")
		    (match_operand:HI 1 "movhi_src_operand" " r, i,i, U,r"))
	       (label_ref (match_operand 2 "" ""))
	       (pc)))
   (clobber (match_scratch:QI 3 "=&hh,&hh,hh,&hh,hh"))]
  ""
...
(define_insn_and_split "cbrhi_gtu"
  [(set (pc) (if_then_else
	       (gtu (match_operand:HI 0 "movhi_src_operand" " r, i,i, U,r")
...
(define_insn_and_split "cbrhi_lt"
  [(set (pc) (if_then_else
		   ...
		   (match_operand:HI 1 "movhi_src_operand"  "r, i,r,i"))
	       (label_ref (match_operand 2 "" ""))
	       (pc)))
