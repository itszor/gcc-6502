...
(define_insn "addhi3_insn"
  ...
  php\;pha\;lda %1\;clc\;adc #<%2\;sta %0\;lda %h1\;adc #>%2\;sta %h0\;pla\;plp"
...
(define_insn "adcqi3_c"
  [(set (match_operand:QI 0 "accumulator_operand" "=Aq,Aq")
   ...
   (set (reg:CC_C CARRY_REGNUM)
	(unspec:CC_C [(match_dup 0) (match_dup 2) (reg:CC_C CARRY_REGNUM)]
		     UNSPEC_ADC_C))
   (clobber (reg:CC_NZ NZ_REGNUM))
   (clobber (reg:CC_V OVERFLOW_REGNUM))]
  ""
...
(define_insn "sbcqi3_nzv"
  [(set (match_operand:QI 0 "accumulator_operand" "=Aq,Aq")
   ...
   (set (reg:CC_NZ NZ_REGNUM)
	(unspec:CC_NZ [(match_dup 0) (match_dup 2) (reg:CC_C CARRY_REGNUM)]
		      UNSPEC_SBC_NZ))
   (set (reg:CC_V OVERFLOW_REGNUM)
	(unspec:CC_V [(match_dup 0) (match_dup 2) (reg:CC_C CARRY_REGNUM)]
		     UNSPEC_SBC_OVF))
   (clobber (reg:CC_C CARRY_REGNUM))]
  ""
  "@
...
(define_insn "negate_highbit"
  [(set (match_operand:QI 0 "accumulator_operand" "=Aq")
	(xor:QI (match_operand:QI 1 "accumulator_operand" "0")
		(const_int 128)))
   (set (reg:CC_NZ NZ_REGNUM)
	(unspec:CC_NZ [(match_dup 0)] UNSPEC_NEG_HIBIT))]
  ""
...
(define_insn "iorqi3_nz"
  [(set (match_operand:QI 0 "accumulator_operand"	  "=Aq,Aq,Aq")
	(ior:QI (match_operand:QI 1 "accumulator_operand"   "0, 0, 0")
		(match_operand:QI 2 "qimode_src_operand"    "r,Uc, I")))
   (set (reg:CC_NZ NZ_REGNUM)
	(unspec:CC_NZ [(match_dup 0) (match_dup 2)] UNSPEC_IOR_CC))]
  ""
  "@
  ora %2
  ora %2
