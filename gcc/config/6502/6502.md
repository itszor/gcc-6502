...
;
;(define_insn "addsi3"
;  [(set (match_operand:SI 0 "zp_reg_operand" "=r,r")
;	(plus:SI (match_operand:SI 1 "zp_reg_operand" "%r,r")
;		 (match_operand:SI 2 "zp_reg_or_imm_operand" "r,i")))]
;  ""
;  "@
;  ;addsi %0,%1,%2
;  ;addsi %0,%1,#%2"
...
;
;(define_insn "lshrsi3"
;  [(set (match_operand:SI 0 "zp_reg_operand" "=r")
;	(lshiftrt:SI (match_operand:SI 1 "zp_reg_operand" "r")
...
;(define_insn "ashlsi3"
;  [(set (match_operand:SI 0 "zp_reg_operand" "=r")
;	(ashift:SI (match_operand:SI 1 "zp_reg_operand" "r")
;		   (match_operand:SI 2 "immediate_operand" "i")))]
;  ""
;  ";ashlsi %0,%1,#%2"
;  [(set_attr "length" "5")])
...
;(define_insn "ashrsi3"
;  [(set (match_operand:SI 0 "zp_reg_operand" "=r")
;	(ashiftrt:SI (match_operand:SI 1 "zp_reg_operand" "r")
;		     (match_operand:SI 2 "immediate_operand" "i")))]
;  ""
;  ";ashrsi %0,%1,#%2"
;  [(set_attr "length" "5")])
...
;	    }
;	}
;      else if (zp_or_hard_reg_operand (operands[0], HImode)
...
;  [(set (match_operand:HI 0 "nonimmediate_operand"
;	       "=hh,Ah,hh,xh,yh,hh, r,hh,Uc,Ah, m,r,r, r,Uc,Uc,?hh, ?m,?r,?m")
;	(match_operand:HI 1 "general_operand"
;		 "i,hh,Ah,xh,yh, r,hh,Uc,hh, m,Ah,r,i,Uc, r, z, ?m,?hh,?m,?r"))]
...
;
;(define_split
;  [(set (match_operand:HI 0 "accumulator_operand" "")
;	(mem:HI (plus:HI (match_operand:HI 1 "zp_reg_operand" "")
...
;(define_insn "addhi3_insn_noclob"
;  [(set (match_operand:HI 0 "register_operand" "=r,r")
;	(plus:HI (match_operand:HI 1 "register_operand" "r,r")
;		 (match_operand:HI 2 "nonmemory_operand" "r,i")))]
;  "reload_in_progress || lra_in_progress || reload_completed"
;  "@
;  pha\;lda %1\;clc\;adc %2\;sta %0\;lda %h1\;adc %h2\;sta %h0\;pla
;  pha\;lda %1\;clc\;adc #<%2\;sta %0\;lda %h1\;adc #>%2\;sta %h0\;pla"
;  [(set_attr "length" "15,15")])
...
(define_insn "lshrhi3"
  [(set (match_operand:HI 0 "register_operand" "=r")
        (lshiftrt:HI (match_operand:HI 1 "register_operand" "r")
		     (match_operand:HI 2 "shifthi_amount" "i")))]
  ""
  ";lshrhi3 %0,%1,%2")
...
/*  if (MEM_P (operands[0]) && !REG_P (XEXP (operands[0], 0)))
    operands[0] = change_address (operands[0], QImode,
...
(define_insn "*movqi_insn"
  [(set (match_operand:QI 0 "mov_dst_operand"
       "=hq,Aq,hq,r,hq, r,hq,Uc,Aq, m,r,Uc,xq,yq,?hq, ?m, *r,r,r,m")
	(match_operand:QI 1 "mov_src_operand"
	 "i,hq,Aq,r, r,hq,Uc,hq, m,Aq,z, z,yq,xq, ?m,?hq,*Ur,i,m,r"))]
  ...
  ;general-load %0,%1
  ;general-store %0,%1"
 [(set_attr "length" "2,1,1,*,2,2,3,3,*,*,2,3,2,2,*,*,7,6,*,*")])
