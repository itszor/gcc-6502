  ...
  ""
{
  if (can_create_pseudo_p ()
	  ...
	  || (!CONSTANT_ADDRESS_P (XEXP (operands[0], 0)) && REG_P (operands[1])
	      && REGNO (operands[1]) != ACC_REGNUM)))
    {
      fprintf (stderr, "copy to mode reg\n");
...
(define_insn "*movqi_insn"
  [(set (match_operand:QI 0 "mov_dst_operand"
       "=hh,Ah,hh,xh,yh,r,hh, r,hh,Uc,Ah, m,r,Uc,xh,yh,hh, m")
	(match_operand:QI 1 "mov_src_operand"
	 "i,hh,Ah,xh,yh,r, r,hh,Uc,hh, m,Ah,z, z,yh,xh, m,hh"))]
  ...
  pha\;lda %1\;ta%R0\;pla
  pha\;t%R1a\;sta %1\;pla"
 [(set_attr "length" "2,1,1,2,2,6,2,2,3,3,2,2,2,3,2,2,5,5")])
